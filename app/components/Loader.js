      ...
      <div style={styles.loader}>
        <div style={styles.truckWrapper}>
          <div style={styles.truckBody}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 198 93" style={styles.trucksvg}>
              ...
              <path strokeWidth={3} stroke="#282828" fill="#7D7C7C" d="M146 33.5H181.741C182.779 34.1415 183.709 35.112 184.078 52.112C191.16 53.748 189.951 55.5 188.201 55.5H146C144.619 55.5 143.5 54.3807 143.5 53V36C143.5 34.6193 144.619 33.5 146 33.5Z" />
              ...
              {/* Company Logo */}
              <image 
                href="https://raw.githubusercontent.com/Pranjulrathour/photo/refs/heads/main/Marketing%20Pitch%20deck.png"
                x="8" 
                y="5" 
                width="118" 
                height="85"
          ...
          <div style={styles.truckTires}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30" style={styles.tiresvg}>
          ...
          <svg xmlSpace="preserve" viewBox="0 0 453.459 453.459" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Capa_1" version="1.1" fill="#000000" style={styles.lampPost}>
